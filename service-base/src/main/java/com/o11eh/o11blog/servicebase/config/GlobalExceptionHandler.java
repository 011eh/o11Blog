...
public class GlobalExceptionHandler {
    ...
    public Result handle1(Exception e) {
        e.printStackTrace();
        return Result.error(e.getMessage()).setCode(1500);
    }
    ...
    public Result handle2(NotPermissionException e) {
        ...
        return Result.error("无权限进行访问").setCode(1401);
    }
    ...
    public Result handle3(MethodArgumentNotValidException e) {
        e.printStackTrace();
        return Result.error(e.getMessage()).setCode(1402);
    }
    ...
    public Result handle3(NotLoginException e) {
        ...
        e.printStackTrace();
        return Result.error(e.getMessage()).setCode(1403);
    }
}
